					...
					<form
						...
						<div>
							<button
								...
								onClick={google}>
								Sign in with <icon className="pl-1"><FontAwesomeIcon icon={faGoogle}/></icon>
							</button>
						</div>
						<div>
							<button
								...
								Sign in with <icon className="pl-1"><FontAwesomeIcon icon={faFacebook}/></icon>
							</button>
						</div>
					</form>
					<p className="mt-10 text-center text-sm text-gray-500">
						Not a member? <a href="/" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> Register Now</a>
					</p>
				</div>
			</div>
		</>
